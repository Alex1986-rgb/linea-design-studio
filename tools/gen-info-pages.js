...
w('about/index.html', page({
  ...
  crumb: 'О студии',
  lead: 'LINEA — небольшая студия с собственным программным конвейером выпуска рабочей документации. Проект ведёт один человек, а рутину — 46 листов чертежей, спецификацию и смету — собирает алгоритм по согласованной геометрии.',
  jsonld: [
  ...
  <div><b>132 листа</b><span>в двух открытых демо-альбомах</span></div>
</div></section>
